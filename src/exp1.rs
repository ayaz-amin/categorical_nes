...
pub fn run_exp1() {
    let root = BitMapBackend::new("charts/simple.png", (640, 480)).into_drawing_area();
    root.fill(&WHITE).unwrap();
    let mut chart = ChartBuilder::on(&root)
        .caption("Simple Program Induction", ("sans-serif", 15).into_font())
        .margin(20)
        .x_label_area_size(40)
        .y_label_area_size(40)
        .build_cartesian_2d(0f32..10000f32, 0f32..1000f32).unwrap();
    ...
    let par_5 = dist::Categorical::new(vec![0.0; 4]);
